...
use crate::{
    ...
    types::{LegSide, MarketSpecIndex, TokenKind},
};

#[cfg(feature = "wasm")]
#[wasm_bindgen]
pub struct WasmMarketCallBuilder {
    inner: MarketCallBuilder,
}
...
impl WasmGoblinCalldataBuilder {
    ...
    pub fn set_eth_withdrawal(&mut self, amount: u64, internally: bool) {
        self.inner.set_eth_withdrawal(amount, internally);
    }
