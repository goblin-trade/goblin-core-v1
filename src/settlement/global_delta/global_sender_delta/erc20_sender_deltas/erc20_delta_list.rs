use crate::{
    ...
    token::{CustomERC20, ERC20Marker, HardcodedERC20, ERC20Index},
};
...
pub trait ERC20DeltaList<T: ERC20Marker> {
    ...
    fn get_delta_mut(&mut self, token_index: ERC20Index<T>) -> &mut ERC20Delta;
}

impl ERC20DeltaList<HardcodedERC20> for SenderHardcodedDeltas {
    fn get_delta_mut(&mut self, token_index: ERC20Index<HardcodedERC20>) -> &mut ERC20Delta {
        &mut self[token_index.inner as usize]
    }
}

impl ERC20DeltaList<CustomERC20> for SenderCustomDeltas {
    fn get_delta_mut(&mut self, token_index: ERC20Index<CustomERC20>) -> &mut ERC20Delta {
        &mut self[token_index.inner as usize]
    }
}
