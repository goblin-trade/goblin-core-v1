...
const INNER_POS_V2: usize = bits(0, 8);
const COLUMN_V2: usize = bits(0, 3);
const ROW_V2: usize = bits(3, 5);
const OUTER_POS_V2: usize = bits(8, 8);
const OUTER_BITMAP_INDEX_V2: usize = bits(16, 48);
const TICK_POS_V2: usize = bits(3, 61);
