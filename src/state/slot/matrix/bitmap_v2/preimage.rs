...
#[repr(C)]
#[derive(Clone, Copy)]
pub struct BitmapPreimageV2<M, B, Q, I, const BIT_OFFSET: usize, const BIT_COUNT: usize>
where
    M: MarketMarker,
    B: TokenMarker,
    Q: TokenMarker,
...
impl<M, B, Q, I, const BIT_OFFSET: usize, const BIT_COUNT: usize> Preimage
    for BitmapPreimageV2<M, B, Q, I, BIT_OFFSET, BIT_COUNT>
where
    M: MarketMarker,
    B: TokenMarker,
    Q: TokenMarker,
