...
// We cannot use struct in P: PairShape, it must be a trait
pub struct PairShape<T0: TokenMarker, T1: TokenMarker>(Pair<T0, T1>);

impl<B: TokenMarker, Q: TokenMarker> PairShape<B, Q> {
