use crate::{
    market::{CommonMarket, DangerousMarketIndex, Hardcoded, HardcodedMarketList, MarketAndKey},
...
impl HardcodedMarketList<ETH, HardcodedERC20> for DangerousMarketIndex<ETH, HardcodedERC20> {
...
impl HardcodedMarketList<HardcodedERC20, ETH> for DangerousMarketIndex<HardcodedERC20, ETH> {
...
impl HardcodedMarketList<HardcodedERC20, HardcodedERC20>
    for DangerousMarketIndex<HardcodedERC20, HardcodedERC20>
{
